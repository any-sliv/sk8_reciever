...
//	__HAL_LINKDMA(&hdma_adc1, DMA_Handle, hdma_adc1);
}
...
{
	/*
	battery percentage:		value returned:
	100- 80								5
	80 - 60								4
	60 - 40								3
	40 - 20								2
	...
	*/
	...
	if( (adcVal <= 4096) && (adcVal > 3902) )	return 5;
	if( (adcVal <= 3902) && (adcVal > 3808) )	return 4;
	if( (adcVal <= 3808) && (adcVal > 3714) )	return 3;
	if( (adcVal <= 3714) && (adcVal > 3620) )	return 2;
	if( (adcVal <= 3620) && (adcVal > 3524) )	return 1;
